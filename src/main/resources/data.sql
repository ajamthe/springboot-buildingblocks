...
insert into user values(102, 'gwiser@stacksimplify.com', 'Greg', 'Wiser', 'operator', 'ssn102', 'gwiser');
insert into user values(103, 'dmark@stacksimplify.com', 'David', 'Mark', 'clerk', 'ssn103', 'dmark');
